...
def parse_args():
    ...
    parser.add_argument('--res_dir', type=str, default='results/omology', help="Path to the directory where to save the test results. Default: results/omology")
    parser.add_argument('--pred_dir', type=str, default='output/omology', help="Path to the directory where to save the predicted alignments. Default: output/omology")
