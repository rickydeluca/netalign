...
def parse_args():
    ...
    parser.add_argument('--res_dir', type=str, default='results/homology', help="Path to the directory where to save the test results. Default: results/homology")
    parser.add_argument('--pred_dir', type=str, default='output/homology', help="Path to the directory where to save the predicted alignments. Default: output/homology")
