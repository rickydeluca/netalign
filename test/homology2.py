...
def parse_args():
    ...
    parser.add_argument('--res_dir', type=str, default='results/homology2', help="Path to the directory where to save the test results. Default: results/homology2")
    parser.add_argument('--pred_dir', type=str, default='output/homology2', help="Path to the directory where to save the predicted alignments. Default: output/homology2")
