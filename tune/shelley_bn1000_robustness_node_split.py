...
if __name__ == '__main__':
    ...
    # Output directory
    res_dir = 'results/robustness/shelley'
    ...
    for feat in feats:
        for embedding_model in embedding_models:
            for matching_model in matching_models:
                betas = [0.001] if matching_model == 'msgm' else ['']
                taus = [1.0] if matching_model == 'msgm' else ['']
                for beta in betas:
                    for tau in taus:
