...
if __name__ == '__main__':
    ...
    # Model
    feats = ['share']
    embedding_models = ['gine2']
    embedding_dims = [512, 256, 32]
    num_layers = [2]
    matching_models = ['sgm']
    ...
    noise_levels = [0.05, 0.10, 0.20, 0.25]

    # Output directory
    res_dir = f'results/robustness/graph_split/shelley/{data}'
                        ...
                        for ed in embedding_dims:
                            for nl in num_layers:
                                for lr in learning_rates:
                                    ...
                                    header = ['model', 'data', 'p_add', 'p_rm', 'dataset_size', 'best_val_acc', 'best_epoch', 'avg_acc', 'training_time']
