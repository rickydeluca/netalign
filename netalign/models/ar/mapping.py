...
from netalign.models.ar.loss import MappingLossFunctions
...
class LinearMapper(Mapper):
    def __init__(self, embedding_dim, source_embedding, target_embedding):
        super(LinearMapper, self).__init__(source_embedding, target_embedding)
...
class MlpMapper(Mapper):
    def __init__(self, embedding_dim, source_embedding, target_embedding, activate_function='sigmoid'):
        ...
        super(MlpMapper, self).__init__(source_embedding, target_embedding)
