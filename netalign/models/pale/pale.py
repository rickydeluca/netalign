...
class PALE(nn.Module):
    def __init__(self, cfg):
        ...
        self.map_train_batchsize = cfg.MODEL.MAPPING.BATCH_SIZE_TRAIN
        self.map_mode = cfg.MODEL.MAPPING.MODE
        self.map_val_batchsize = cfg.MODEL.MAPPING.BATCH_SIZE_VAL
        self.map_validate = cfg.MODEL.MAPPING.VALIDATE
        self.map_patience = cfg.MODEL.MAPPING.PATIENCE
        ...
        self.map_hidden_layers = cfg.MODEL.MAPPING.NUM_HIDDEN
        ...
        self.map_loss_fn = cfg.MODEL.MAPPING.LOSS_FUNCTION
        self.map_tau = cfg.MODEL.MAPPING.TAU
        self.map_beta = cfg.MODEL.MAPPING.BETA
        self.map_top_k = cfg.MODEL.MAPPING.TOP_K
    ...
    def align(self, pair_dict):
        ...
        if self.map_validate:
            self.gt_val = pair_dict['val_dict']
